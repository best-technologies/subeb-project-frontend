            ...
            <Table>
              ...
              <TableBody>
                {Array.from({ length: 8 }).map((_, index) => (
                  <TableRow key={index} className="border-b border-gray-100/70">
                    <TableCell className="text-center">
                      <div className="h-4 w-6 bg-gray-200/80 rounded animate-pulse mx-auto" />
                    </TableCell>
                    <TableCell>
                      <div className="space-y-1.5">
                        <div className="h-4 w-52 bg-gray-200/80 rounded animate-pulse" />
                    ...
                    <TableCell className="text-center">
                      <div className="h-5 w-16 bg-gray-200/80 rounded-full animate-pulse mx-auto" />
                    </TableCell>
                    <TableCell className="text-center">
                      <div className="h-4 w-12 bg-gray-200/80 rounded animate-pulse mx-auto" />
                    </TableCell>
                    <TableCell className="text-center">
                      <div className="h-4 w-12 bg-gray-200/80 rounded animate-pulse mx-auto" />
                    </TableCell>
                    <TableCell className="text-center">
                      <div className="h-4 w-14 bg-gray-200/80 rounded animate-pulse mx-auto" />
                    </TableCell>
                    <TableCell className="text-center">
                      <div className="h-7 w-16 bg-gray-200/80 rounded-lg animate-pulse mx-auto" />
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
