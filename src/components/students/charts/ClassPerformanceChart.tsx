      ...
      <CardContent className="pt-2 flex-1 flex flex-col justify-center">
        {chartData.length === 0 ? (
          <div className="h-[240px] flex flex-col items-center justify-center text-center p-4 text-gray-400">
            <GraduationCap className="w-8 h-8 stroke-[1.5] text-gray-300 mb-2" />
            <p className="text-xs font-semibold text-gray-600">No Class Records</p>
            <p className="text-[11px] text-gray-400 max-w-[220px] mt-0.5">
              No class assessment records available for this academic period.
            </p>
          </div>
        ) : (
