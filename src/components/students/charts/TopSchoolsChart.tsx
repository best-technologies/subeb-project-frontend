        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <CardDescription className="text-xs text-gray-500">
              Highest scoring schools in the state
            </CardDescription>
          </div>
        </div>
      </CardHeader>
      <CardContent className="pt-2 flex-1 flex flex-col justify-center">
        {chartData.length === 0 ? (
          <div className="h-[240px] flex flex-col items-center justify-center text-center p-4 text-gray-400">
            <SchoolIcon className="w-8 h-8 stroke-[1.5] text-gray-300 mb-2" />
            <p className="text-xs font-semibold text-gray-600">No School Records</p>
