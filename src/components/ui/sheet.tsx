...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-white p-6 shadow-xl transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-400 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full w-full border-l border-gray-200 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-md md:max-w-lg lg:max-w-xl",
      },
    },
    defaultVariants: {
      side: "right",
      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            className="absolute top-4 right-4 rounded-full p-1.5 text-gray-400 hover:text-gray-700 hover:bg-gray-100 transition-colors focus:ring-2 focus:ring-emerald-500 focus:outline-hidden disabled:pointer-events-none"
          >
